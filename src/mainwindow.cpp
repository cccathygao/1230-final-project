...
void MainWindow::initialize() {
    ...
    filter2->setText(QStringLiteral("Blur Filter"));
    ...
    // Extra Credit:
    ec1 = new QCheckBox();
    ec1->setText(QStringLiteral("LoD number-based"));
    ec1->setChecked(false);

    ec2 = new QCheckBox();
    ec2->setText(QStringLiteral("LoD distance-based"));
    ...
    ec4 = new QCheckBox();
    ec4->setText(QStringLiteral("Eagle shadow"));
